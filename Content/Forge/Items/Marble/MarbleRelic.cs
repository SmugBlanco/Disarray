...
namespace Disarray.Content.Forge.Items.Marble
{
	public class MarbleRelic : Materials
	{
		...
		public override void HoldItem(Player player) => PlayerProperty.ImplementProperty(player, new MarbleEnergyRelease() { EffectStrength = 1, OrbChance = 0.05f }, false);

		public override void UpdateEquip(Player player) => PlayerProperty.ImplementProperty(player, new MarbleEnergyRelease() { EffectStrength = 1, OrbChance = 0.05f }, false);

		public override void UpdateAccessory(Player player, bool hideVisual) => PlayerProperty.ImplementProperty(player, new MarbleEnergyRelease() { EffectStrength = 1, OrbChance = 0.05f }, false); 
