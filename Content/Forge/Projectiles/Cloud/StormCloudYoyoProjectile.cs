...
namespace Disarray.Content.Forge.Projectiles.Cloud
{
	public class StormCloudYoyoProjectile : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			...
			ProjectileID.Sets.YoyosMaximumRange[projectile.type] = 225; // vanilla ranges from 130f(Wood) to 400f(Terrarian)
			ProjectileID.Sets.YoyosTopSpeed[projectile.type] = 17.5f; // vanilla ranges from 9f(Wood) to 17.5f(Terrarian)
		}
