...
namespace Disarray.Content.Forge.Projectiles.Granite
{
	public class GraniteEnergyOrb : ModProjectile
	{
		...
		public override void AI()
		{
			...
			Dust spawnedDust = Dust.NewDustDirect(projectile.position, 0, 0, 88);
