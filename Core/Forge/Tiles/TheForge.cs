...
using Disarray.Core.Forge.UI;

namespace Disarray.Core.Forge.Tiles
{
	public class TheForge : ModTile
	{
		...
		{
			Item.NewItem(i * 16, j * 16, 32, 16, mod.ItemType("TheForge"));
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.showItemIcon2 = mod.ItemType("TheForge");
