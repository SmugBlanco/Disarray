...
{
	public class Iteru : Materials
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Iteru");
			Tooltip.SetDefault("Allows attacks to grant 'Secrets of the Sand'"
			+ "\nWhile 'Secrets of the Sand' is active your damage output increases by 2%.");
		}
