...
{
	public class Seba : Materials
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Seba");
			Tooltip.SetDefault("Allows attacks to grant 'Secrets of the Sand'"
			+ "\nWhile 'Secrets of the Sand' is active your mana regeneration increases by 2.");
		}
		...
		public override void ApplyToAllScenarios(Player player)
		{
			...
			artifacts.ManaRegenerationIncrease += 2;
