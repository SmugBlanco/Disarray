...
{
	public class PoisonVial : ForgeComponent
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Poison Vial");
		...
		public override void ApplyToAllScenarios(Player player) => player.GetModPlayer<PoisonPlayer>().PoisonousAttackChance += 0.03f;
