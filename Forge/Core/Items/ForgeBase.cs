...
{
	public abstract partial class ForgeBase : ModItem, IAlmanacable
	{
		/// <summary>
		/// Item type, Slot data
		/// </summary>
		...
		public bool AutoloadArmor(string name, Terraria.Item item, EquipType equipType, string AltItemTexturePath = "")
		{
