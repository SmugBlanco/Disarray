...
namespace Disarray.Forge.Core.Items
{
	public class ForgeItem : ForgeBase
	{
		...
		public Templates ForgedTemplate => AllBases.FirstOrDefault(template => template is Templates) as Templates;
		...
		public void Reset() => AllBases.Clear();

        public override void SetDefaults()
		{
			if (AllBases.Count <= 0 || ForgedTemplate is null)
			{
				item.width = 32;
				item.height = 32;
				Reset();
