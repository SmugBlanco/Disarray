namespace Disarray.ID
{
    public static class DustID
    {
        ...
        public const short CrystalShard_Blue = 68;

        public const short CrystalShard_Pink = 69;

        public const short CrystalShard_Purple = 70;
